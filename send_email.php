...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Email information
    $to = "benjaminmusyoki064@gmail.com"; // Replace with your email address
    $subject = "New Message from KilimoKe Contact Form";
    $body = "Name: $name\nEmail: $email\n\nMessage:\n$message";
    ...
    try {
        ...
        $mail->Password = 'bzevpvakkxignqkm'; // Use app-specific password if 2FA is enabled
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port = 587;

        // Recipients
        $mail->setFrom('benjaminmusyoki064@gmail.com', 'KilimoKe Contact Form');
        $mail->addAddress($to);

...
function sendOtpEmail($email, $otp) {
    ...
    try {
        ...
        $mail->SMTPAuth   = true;                                  
        $mail->Username   = 'benjaminmusyoki064@gmail.com'; // SMTP username
        $mail->Password   = 'bzevpvakkxignqkm'; // SMTP password (use an App Password if 2FA is enabled)
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         
        $mail->Port       = 587;                                   

        //Recipients
        $mail->setFrom('no-reply@kilimoke.com', 'KilimoKe');
